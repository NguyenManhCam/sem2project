// Cloned from loopback-api-explorer package
// Deface UI of Loopback API Explorer to Document friendly

'use strict';

var SG = require('strong-globalize');
SG.SetRootDir(__dirname + '/../docs');
var g = SG();
...
module.exports = function (loopbackApp, options) {
    ...
    function explorer(loopbackApplication, options) {
        options = _defaults({}, options, { mountPath: '/document' });
    ...
    function routes(loopbackApplication, options) {
        ...
        if (options.swaggerUI) {
            ...
            // Mount Swagger after static file handler registered, so application will load static api-def.json
